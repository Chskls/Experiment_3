...
int main()
{
	int x,i,y,arr1[i],arr2[i],arr3[i],sum,arr4[x],day,a,b,c,d,num[b];
 
	cout<<"Record the temperature for a week of Province A, Province B and Province C. \n";
   ...
   for(i = 0; i < 7; i++)
    {
       cout << "Province A, Day " << i + 1 << "  : ";cin >> arr4[x];
    	x++;
    }
   ...
   for(i = 0; i < 7; i++)
    {
       cout << "Province B, Day " << i + 1 << "  : "; cin >> arr4[x];
       x++;
	}
